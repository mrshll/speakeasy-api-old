...
@implementation FPMPresentingAnimator
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext
{
  ...
  toView.frame = CGRectMake(0,
                            0,
                            CGRectGetWidth(transitionContext.containerView.bounds) * 0.75,
                            CGRectGetHeight(transitionContext.containerView.bounds) * 0.40);
